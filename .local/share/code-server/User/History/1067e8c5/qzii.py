...
q4 = df.groupby('Day')['Total Sales'].sum().idxmax()
print(f'[Q4] Highest Selling Day: {q4}\n')

# Q5: 3 Least selling products
q5 = df.groupby('Product')['Units'].sum().sort_values().head(3)
print('[Q5] 3 Least Selling Products:')
print(q5)